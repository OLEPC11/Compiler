...
public interface JsxParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JsxParser#style}.
	 * @param ctx the parse tree
	 */
	void enterStyle(JsxParser.StyleContext ctx);
	/**
	 * Exit a parse tree produced by {@link JsxParser#style}.
	 * @param ctx the parse tree
	 */
	void exitStyle(JsxParser.StyleContext ctx);
	/**
	 * Enter a parse tree produced by {@link JsxParser#height}.
	 * @param ctx the parse tree
	 */
	void enterHeight(JsxParser.HeightContext ctx);
	/**
	 * Exit a parse tree produced by {@link JsxParser#height}.
	 * @param ctx the parse tree
	 */
	void exitHeight(JsxParser.HeightContext ctx);
	/**
	 * Enter a parse tree produced by {@link JsxParser#width}.
	 * @param ctx the parse tree
	 */
	void enterWidth(JsxParser.WidthContext ctx);
	/**
	 * Exit a parse tree produced by {@link JsxParser#width}.
	 * @param ctx the parse tree
	 */
	void exitWidth(JsxParser.WidthContext ctx);
	/**
	 * Enter a parse tree produced by {@link JsxParser#margin}.
	 * @param ctx the parse tree
	 */
	void enterMargin(JsxParser.MarginContext ctx);
	/**
	 * Exit a parse tree produced by {@link JsxParser#margin}.
	 * @param ctx the parse tree
	 */
	void exitMargin(JsxParser.MarginContext ctx);
	/**
	 * Enter a parse tree produced by {@link JsxParser#marginKay}.
	 * @param ctx the parse tree
	 */
	void enterMarginKay(JsxParser.MarginKayContext ctx);
	/**
	 * Exit a parse tree produced by {@link JsxParser#marginKay}.
	 * @param ctx the parse tree
	 */
	void exitMarginKay(JsxParser.MarginKayContext ctx);
	/**
