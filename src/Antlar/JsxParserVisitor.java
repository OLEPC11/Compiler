...
public interface JsxParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JsxParser#height}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHeight(JsxParser.HeightContext ctx);
	/**
	 * Visit a parse tree produced by {@link JsxParser#width}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWidth(JsxParser.WidthContext ctx);
	/**
	 * Visit a parse tree produced by {@link JsxParser#margin}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMargin(JsxParser.MarginContext ctx);
	/**
	 * Visit a parse tree produced by {@link JsxParser#marginKay}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMarginKay(JsxParser.MarginKayContext ctx);
	/**
