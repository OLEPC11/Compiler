...
//                if(getCurrentScope().searchForSymbol(singleExpressions.get(i).identifierExpression.identifier.identifier)!=null&&getCurrentScope().getId()>=getCurrentScope().searchForSymbol(singleExpressions.get(i).identifierExpression.identifier.identifier).getScope().getId())
//                {
//                    createSymbol(getCurrentScope().getId(),singleExpressions.get(i).identifierExpression.identifier.identifier,getCurrentScope().searchForSymbol(singleExpressions.get(i).identifierExpression.identifier.identifier).getType());
//                }
//                else {
//                    System.err.println("Var Never Declare Before");
//                }
