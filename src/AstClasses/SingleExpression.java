...
public class SingleExpression extends Node {
    ...
    public String CodeGen() {
        ...
        if (additiveExpression != null) {
            return additiveExpression.CodeGen();
        }
        if (multiplicativeExpression != null) {
            return multiplicativeExpression.CodeGen();
        }
        if (arrayLiteralExpression != null) {
            return arrayLiteralExpression.CodeGen();
        }
        if (objectLiteralExpression != null) {
            return objectLiteralExpression.CodeGen();
        }
        if (identifierExpression != null) {
            return identifierExpression.CodeGen();
        }
        if (literalExpression != null) {
            return literalExpression.CodeGen();
        }
        if (assignmentExpression != null) {
            return assignmentExpression.CodeGen();
        }
        if (memberDotExpression != null) {
            return memberDotExpression.CodeGen();
        }
        if (ternaryExpression != null) {
            return ternaryExpression.CodeGen();
        }
        if (argumentsExpression != null) {
            return argumentsExpression.CodeGen();
        }
        if (memberIndexExpression != null) {
            return memberIndexExpression.CodeGen();
        }
        if (functionExpression != null) {
            return functionExpression.CodeGen();
        }
        return "  ";
    }
